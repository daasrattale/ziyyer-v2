...
extension IsarTransactionQueryWhereDistinct
  ...
  QueryBuilder<IsarTransaction, IsarTransaction, QDistinct> distinctByCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IsarTransactionQueryProperty
  ...
  QueryBuilder<IsarTransaction, int, QQueryOperations> accountIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarTransaction, String?, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
